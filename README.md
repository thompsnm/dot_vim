 ...
 * [ale](https://github.com/w0rp/ale) - Check syntax (linting) and fix files asynchronously, with Language Server Protocol (LSP) integration in Vim
...
_That's 66 plugins, holy crap._
